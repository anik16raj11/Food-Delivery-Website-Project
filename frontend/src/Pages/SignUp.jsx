    ...
    <div className='min-h-screen w-full flex items-center justify-center p-4' style=
      ...
      <div className={`bg-white rounded-xl shadow-lg w-full max-w-md p-8 border-[1px]`} style={{ border: `1px solid ${borderColor}` }}>
        ...
        <div className='mb-4'>
          ...
          <input type="text" className='w-full border rounded-lg px-3 py-1.5 focus:outline-none ' placeholder='Enter Your Full Name' style={{ border: `1px solid ${borderColor}` }} onChange={(e)=>setFullName(e.target.value)} value={fullName} required />
        </div>
        ...
        <div className='mb-4'>
          ...
          <input type="mobile" className='w-full border rounded-lg px-3 py-1.5 focus:outline-none ' placeholder='Enter Your Mobile Number' style={{ border: `1px solid ${borderColor}` }} onChange={(e)=>setMobile(e.target.value)} value={mobile} required />
        </div>
        ...
        <div className='mb-4'>
          ...
          <div className='flex gap-2'>
            {["user", "owner", "deliveryBoy"].map((r, index) => (
              <button key={index} className='flex-1 border rounded-lg px-3 py-2 text-center font-medium transition-colors cursor-pointer'
                onClick={() => setRole(r)}
                style={
                  role == r ?
